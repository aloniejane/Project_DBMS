...
public class ViewItemController implements Initializable {
    ...
    String catid,img,desc,siz,col,cloth_no;
    static int cst;
    static int qty=1; //selected quantity
     ...
     public void Choice()
   {
    ...
    public void Add(MouseEvent event) throws IOException
    {
        ...
        try
        {
                    ...
                    String query="select * from men where description= '"+ds+"'";
                    ...
                    while (rs.next())
                    {
                        ...
                        col=rs.getString("COLOUR");
                        cst=Integer.parseInt(rs.getString("COST"));
                        
                    }
                    String query1="select * from clothes where mcatid = '"+catid+"' and clothsize = '"+siz+"'";
                    System.out.println("Getting clno"+query1);
         ...
         try
        {
                    ...
                    String query="select * from clothes where clothno= '"+cloth_no+"' and clothsize= '"+siz+"' ";
                    System.out.println("Cloth query "+query);
         ...
         try
        {
                    ...
                    String query="select * from cart where id = '"+cloth_no+"' and clsize = '"+siz+"'";
