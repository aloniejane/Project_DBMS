...
public class ElectronicsController implements Initializable 
{
    ...
    {  
        ViewItem3Controller vc=new ViewItem3Controller();
   ...
   public void Choice1()
   {
    ...
    public void Display()
    {
        ...
        try  //Result set for Images of Clothes
        {
                   ...
                   {
                       query="select *from electronics order by eprice";
                   }
                   else if(ch_no==2)
                   {
                       query="select * from electronics order by eprice desc";
                   }
                    ...
                    while (rs.next())
                    {
                        ...
                        des[i]=rs.getString("type");
                        cid[i]=rs.getString("eno");
                        cost[i]= rs.getString("eprice");
                        i++;
...
//             
//                   
//                    String query="select cprice from men order by cost";
//
//                    ResultSet rs = stat.executeQuery(query);
//                    k=0;
//                    while (rs.next())
...
//        
    ...
    public void Clkimg1(MouseEvent event) throws IOException
    {
       ...
       {
            ViewItem3Controller.Display(imag,ds,ct);
            Parent root = FXMLLoader.load(getClass().getResource("ViewItem3.fxml"));
            Stage stage1 = new Stage();
            stage1.initStyle(StageStyle.UNDECORATED);
            Scene scene3 = new Scene(root);
            stage1.setScene(scene3);
    ...
    private void Search(MouseEvent event) 
    {
        ...
        try
        {
                    ...
                    String query="select image from electronics where type like'%"+src+"%'";
