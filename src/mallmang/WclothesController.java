...
public class WclothesController implements Initializable 
{
    ...
    {  
        ViewItem1Controller vc=new ViewItem1Controller();
   ...
   public void Choice1()
   {
    ...
    public void Display()
    {
        ...
        try  //Result set for Images of Clothes
        {
                   ...
                   {
                       query="select * from women order by cost";
                   }
                   else if(ch_no==2)
                   {
                       query="select * from women order by cost desc";
                   }
                   System.out.println(query);
                    ...
                    while (rs.next())
                    {
                        if(rs.getString("CATID").equals("W00"))
                            continue;
    ...
    public void Clkimg1(MouseEvent event) throws IOException
    {
       ...
       {
            ViewItem1Controller.Display(imag,ds,ct);
            Parent root = FXMLLoader.load(getClass().getResource("ViewItem1.fxml"));
            Stage stage1 = new Stage();
            stage1.initStyle(StageStyle.UNDECORATED);
            Scene scene3 = new Scene(root);
            stage1.setScene(scene3);
    ...
    private void Search(MouseEvent event) 
    {
        ...
        try
        {
                    ...
                    String query="select * from women where description like'%"+src+"%' escape'\\'";
